...
setwd("C:/Users/s165048/OneDrive - TU Eindhoven/QuinceyFinalProject/final-project/src/digested literature/Bringmann et al - A Network Approach to Psychopathology New Insights into Clinical Longitudinal Data")
...
networkdata=read.table(file="Data S1.txt",header=TRUE,sep=",")
